			...
			<Container className="relative z-10 flex flex-col-reverse md:flex-row items-center gap-12 md:gap-16">
					...
					>
						...
						<Dialog>
							...
							>
								...
								<div className="relative w-full aspect-video rounded-xl overflow-hidden bg-gray-900 z-1">
									<Image
										src={project.image}
										alt={project.title}
										width={1600}
				...
				>
					<CometCard className="w-full h-full">
						<div className="w-full h-full rounded-xl bg-linear-to-br from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-900 border border-gray-200 dark:border-gray-800 overflow-hidden relative">
							<Image
								src={project.image}
								alt={project.title}
								fill
